...
void saveScreenshot() {
	...
	FreeImage_Save(FIF_PNG, img, "/Users/lidongpeng/ldp/CS184.1X/hw0-osx-10.9/screenshot.png", 0);
}
...
void init (void) 
{
	...
	vertexshader = initshaders(GL_VERTEX_SHADER, "/Users/lidongpeng/ldp/CS184.1X/hw0-osx-10.9/shaders/light.vert.glsl") ;
	fragmentshader = initshaders(GL_FRAGMENT_SHADER, "/Users/lidongpeng/ldp/CS184.1X/hw0-osx-10.9/shaders/light.frag.glsl") ;
	...
	inittexture("/Users/lidongpeng/ldp/CS184.1X/hw0-osx-10.9/wood.ppm", shaderprogram) ; 
